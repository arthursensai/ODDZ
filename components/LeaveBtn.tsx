...
const LeaveButton: React.FC<LeaveButtonProps> = ({
  ...
  const getButtonStyles = () => {
    const base =
      "hover:cursor-pointer inline-flex items-center justify-center font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed";
    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
        <motion.div
          ...
          className="bg-white border border-red-200 rounded-xl p-6 shadow-2xl w-full max-w-sm"
        >
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Are you sure you want to leave the room? This action cannot be
              undone.
            </p>
            <div className="flex gap-3">
              ...
              <motion.button
                ...
                onClick={handleLeave}
                disabled={isLeaving}
                className="flex-1 px-4 py-2 text-sm font-medium text-white bg-red-500 hover:bg-red-600 rounded-lg transition disabled:opacity-50"
              >
